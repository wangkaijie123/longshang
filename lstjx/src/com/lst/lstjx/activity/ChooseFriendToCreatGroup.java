 ...
 */
public class ChooseFriendToCreatGroup extends Activity implements
		OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.ac_choose_friend_creat_group);
		initView();
		requstFriendList();
	}
	...
	private void initView() {
		// TODO Auto-generated method stub
		userid = SharePrefUtil.getString(ChooseFriendToCreatGroup.this,
				"userId", "");
...
//		            			List<String> nameList = new ArrayList<String>();
		            			...
		            			for (int i = 0; i < mChecked.size(); i++) {
		            			 ...
		            			 RongIM.getInstance().createDiscussionChat(ChooseFriendToCreatGroup.this,
		    							 fidList , inputName);
		            			 
		            			ChooseFriendToCreatGroup.this. finish();
		                    }
		                });
		        builder.show();
			break;
	...
	private void requstFriendList() {
		...
		http.post(ChooseFriendToCreatGroup.this, ConstantsUrl.getFriendList,
