...
import com.lst.lstjx.fragment.MyWlFragment.GridViewAdapter;
import com.lst.lstjx.fragment.MyWlFragment.MyWlAdapter.viewHolder;
...
public class AllCarSxFragment extends Fragment {
	...
	public AllCarSxFragment(String starting, String ending, String time) {
		super();
	...
	private void getAllBuyDinamic(final int i, String starting, String ending,
		...
		if (starting != null) {
			...
			System.out.println("000000starting00000" + starting);
		}
		if (ending != null) {

			params.add("ending", ending);
			System.out.println("0000000ending0000" + ending);
		}
		if (time != null) {
			System.out.println("00000time000000" + time);
	...
	class MyAllCarDynamicAdapter extends BaseAdapter {
		...
		public View getView(final int position, View convertView,
			...
			if (convertView == null) {
				...
				holder.carDynamic = (TextView) convertView
						.findViewById(R.id.carDynamic);
			...
			holder.carDynamic.setOnClickListener(new OnClickListener() {
