...
public class AllSellDynamicFragment extends Fragment {
...
//	private MyDeal myDeal2;
	...
	private void getAllBuyDinamic(final int i) {
		// TODO Auto-generated method stub
		mDialog = DialogUtil.createProgressDialog(getActivity(), "正在加载数据...");
		...
		mPullRefreshListView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				intent.setClass(getActivity(),
						DynamicDetailCanPublishActivity.class);
				intent.putExtra("username", arrayList.get(arg2 - 1).getUname());
				intent.putExtra("id", arrayList.get(arg2 - 1).getId());
				intent.putExtra("uid", arrayList.get(arg2 - 1).getUid());
...
//			final int coord = position;
			...
			if (convertView1 == null) {
				...
				convertView1 = inflater.inflate(R.layout.item_published_grida,
						parent, false);
				holder = new ViewHolder();
				holder.image = (ImageView) convertView1
