...
import com.lst.lstjx.fragment.FriendCarsFragment.MyCarAdapter.HolderView;
 ...
 */
public class FriendCarsFragment extends Fragment implements OnClickListener {
	...
	public FriendCarsFragment(String hisuserid) {
	...
	public View onCreateView(LayoutInflater inflater,
		...
		if (Dynamic == null) {
			Dynamic = inflater.inflate(R.layout.activity_friend_car, container,
					false);
		}
		initView(Dynamic);
		reqCar(1);
